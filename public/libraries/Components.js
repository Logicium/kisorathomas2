var div = function(){return $('<div>').css('padding','0')};
...
var col = function(width){
    width = width || '';
    return  div().css({'display':'flex','flex-direction':'column','width':width});
};
...
var row = function(){
    return $('<div>').addClass('row').css('margin','0 auto').css({'display':'flex'});
};
...
var image = function(url){
    return $('<div>').css('width','100%').css('min-height','200px').css('background-image','url('+ url +')').css('background-size','cover');
};
...
var roundButton = function(){
    return div().css({'height':'75px','width':'75px','border-radius':'50%','background-color':'#f5f3ee'})
}

var longButton = function(){
    return div().css({'height':'75px','width':'150px','border-radius':'0%','background-color':'#f5f3ee'})
}
...
var verticalLine = function(){
    return col('2px').addClass('vline').css({'height':'0%','background-color':'#1e1d23'});
}
